...
class Game():
    def __init__(self, size_field_in_blocks: tuple) -> None:
        global SIZE_BLOCK, SIZE_FIELD_IN_BLOCKS, SIZE_SPACE, SIZE_WINDOW, COLOR_BACKGROUND, COLOR_BLOCK, COLOR_APPLE, COLOR_FONT, COLOR_WIN_TEXT, COLOR_OVER_TEXT, W, C, WIN_TEXT, OVER_TEXT, FPS, TIME_DELAY_MOVE, FONT_FILE, t, snake_vector, temporary_vector, all_cells, null_cells, snake, apple
